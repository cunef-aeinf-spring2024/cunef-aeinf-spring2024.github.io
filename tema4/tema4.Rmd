...
3. Homocedasticidad: la variance de los errores es constante.
...
* Un modelo de regresión linea simple parece razonable $y = \beta_0 + \beta_1 x + \epsilon$ con $\epsilon \sim \mathcal{N}(0, \sigma^2)$.

* Vamos a asumir que $\sigma^2$ es conocido luego los parámetros de interés son $\hat{\beta}_0$ y $\hat{\beta}_1$.
...
* En este curso no nos centraremos en este aspecto. Únicamente trabajaremos con los estimadores puntuales y nos centraremos en cómo usar estos modelos para explorar los datos.
